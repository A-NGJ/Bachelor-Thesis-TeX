...
The entire algorithm was written in \emph{Python} 3.9.7 using \emph{pytorch} 1.9.1 library. An image preprocessing part was held in \emp{opencv-python} 4.5.3.56. Source code with all dependencies can be found at \emph{github repository}\footnote{\url{https://github.com/A-NGJ/bachelor_thesis}}.
