...
\titlePL{Wizyjny system kontroli trasy autonomicznej łodzi korzystający z metod uczenia maszynowego}
...
\begin{document}
	...
	\include{chapters/3_DeepLearning}
	\include{chapters/4_ConvolutionalNN}
	\include{chapters/5_ReinforcementNN}
	\include{chapters/6_VisionSystem}
	\include{chapters/7_Results}
